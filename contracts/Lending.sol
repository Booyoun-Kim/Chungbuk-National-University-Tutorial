...
contract Lending {
    ...
    constructor(IERC20 _tGPC, IERC20 _tUSDT) {
        tGPC = _tGPC;
        tUSDT = _tUSDT;
        owner = msg.sender;
    }
    ...
    function deposit(uint256 amount) external {
        ...
        require(tGPC.transferFrom(msg.sender, address(this), amount), "Transfer failed");
    ...
    function borrow(uint256 tUSDTAmount) external {
        ...
        require(tUSDT.transfer(msg.sender, tUSDTAmount), "Transfer failed");
    ...
    function repay(uint256 tUSDTAmount) external {
        ...
        tUSDTLoans[msg.sender] -= tUSDTAmount;
        tGPCBalances[msg.sender] += requiredCollateral;
        require(tUSDT.transferFrom(msg.sender, address(this), tUSDTAmount), "Transfer failed");
